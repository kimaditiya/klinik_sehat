...
/* @var $searchModel backend\master\models\TypeObatSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Type Obats';
...
function tombolCreate(){
      $title1 = Yii::t('app', 'New type Obat');
      $url = Url::toRoute(['/master/type-obat/create']);
      $options1 = ['value'=>$url,
                    'id'=>'typeobat-id-create',
  ...
  */
  function tombolView($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/type-obat/view','id'=>$model->id_type]);
        $options1 = ['value'=>$url,
                    'id'=>'typeobat-id-view',
  ...
  */
  function tombolUpdate($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/type-obat/update','id'=>$model->id_type]);
        $options1 = ['value'=>$url,
                    'id'=>'typeobat-id-edit',
                    'class'=>"btn btn-default btn-xs",      
                    'style'=>['width'=>'170px', 'height'=>'25px','border'=>'none','background-color'=>'white'],  
  ...
  */
  function tombolDelete(){
      ...
      $options = ['id'=>'typeobat-id-delete',
                  'data-pjax' => 0,
                  'data-toggle-delete-erp'=>'typeobat-pilih-delete',
...
$headColomnBT=[
    ['ID' =>0, 'ATTR' =>['FIELD'=>'type_obat','SIZE' => '30px','label'=>'Type Obat','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
...
$attDinamik[] =[
      ...
      'detail'=>function ($model, $key, $index, $column){
        return Yii::$app->controller->renderPartial('expand_row_typeobat',[
          'model1'=>$model,
        ]); 
      },
...
echo \Yii::$app->view->renderFile('@backend/master/views/type-obat/modal_typeobat.php'); // view modal

$urls = [
    'deleteurltypeobat' => Url::toRoute(['/master/type-obat/pilih-delete']),
];
...
$this->registerJs($this->render('all_typeobat.js'),View::POS_READY);
