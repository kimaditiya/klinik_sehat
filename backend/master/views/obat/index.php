...
/* @var $searchModel backend\master\models\ObatSearch */
...
function tombolCreate(){
      $title1 = Yii::t('app', 'New Obat');
      $url = Url::toRoute(['/master/obat/create']);
      $options1 = ['value'=>$url,
                    'id'=>'obat-id-create',
  ...
  */
  function tombolView($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/obat/view','id'=>$model->kd_obat]);
        $options1 = ['value'=>$url,
                    'id'=>'view-obat-id-id',
  ...
  */
  function tombolUpdate($url, $model){
        ...
        $label = $icon . ' ' . $title;
        $url = Url::toRoute(['/master/obat/edit','id'=>$model->kd_obat]);
        $options1 = ['value'=>$url,
                    'id'=>'edit-obat-id',
                    'class'=>"btn btn-default btn-xs",      
                    'style'=>['width'=>'170px', 'height'=>'25px','border'=>'none','background-color'=>'white'],  
  ...
  */
  function tombolDelete(){
      ...
      $options = ['id'=>'obat-id-delete',
                  'data-pjax' => 0,
                  'data-toggle-delete-erp'=>'obat-delete',
...
$headColomnBT=[
    ['ID' =>0, 'ATTR' =>['FIELD'=>'nama_obat','SIZE' => '30px','label'=>'Nama Obat','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
    ['ID' =>1, 'ATTR' =>['FIELD'=>'nametype','SIZE' => '30px','label'=>'Type Obat','align'=>'left','warna'=>'73, 162, 182, 1','grp'=>false]],
...
$attDinamik[] =[
      ...
      'detail'=>function ($model, $key, $index, $column){
        return Yii::$app->controller->renderPartial('expand_row_obat',[
          'model1'=>$model,
        ]); 
      },
...
foreach($gvHeadColomnBT as $key =>$value[]){
  ...
  }elseif($value[$key]['FIELD'] == 'nametype'){
    $attDinamik[]=[
        'class'=>'kartik\grid\EditableColumn',
        'attribute'=>$value[$key]['FIELD'],
        'label'=>$value[$key]['label'],
        'filterType'=>GridView::FILTER_SELECT2,
        'filter' => $data_type_obat,
        'filterWidgetOptions'=>[
          'pluginOptions'=>['allowClear'=>true],
        ],
        'filterInputOptions'=>['placeholder'=>'Pilih'],
        'editableOptions' => [
          ...
          // Refresh Display
          'displayValueConfig' => $data_type_obat,
        ],
        'hAlign'=>'right',
        'vAlign'=>'middle',
        'noWrap'=>true,
...
echo \Yii::$app->view->renderFile('@backend/master/views/obat/modal_obat.php'); // view modal

$urls = [
    'deleteurlobat' => Url::toRoute(['/master/obat/pilih-delete']),
];
...
$this->registerJs($this->render('all_obat.js'),View::POS_READY);